  ...
  describe('Class definitions', () => {
    ...
    it('should handle default values generated by TypeDoc 0.20.x', () => {
      ...
      expect(def.properties as any).toEqual([{
        isOptional: true,
        name: 'messageStream',
        type: { type: 'reference', name: 'Subject', typeArguments: [ { type: 'reference', name: 'SkyColorpickerMessage' } ] },
        description: 'Provides an observable to send commands to the colorpicker. The commands should\nrespect the `SkyColorPickerMessage` type.',
